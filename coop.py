...
class CustomCLIP(nn.Module):
    def __init__(self, clip_model):
        super().__init__()
        classes = pd.read_csv('/mnt/sdb/data/jingyinuo/animal_kingdom/animal_label.csv', index_col=0).values.tolist()
        classnames = []
...
def load(model_path, name: str, device: Union[str, torch.device] = "cuda" if torch.cuda.is_available() else "cpu", 
         ...
         use_cache=True, prompts_alpha=1e-1, prompts_layers=2, mit_layers=1, 
):
